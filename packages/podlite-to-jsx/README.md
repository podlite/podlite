<p align="center">
  <picture>
    ...
    <img src="https://raw.githubusercontent.com/podlite/podlite/main/assets/podlite-mark-core.svg" width="350" alt="@podlite/to-jsx">
  </picture>
</p>
<p align="center"><em>render Podlite markup as React JSX components</em></p>

```sh
npm install @podlite/to-jsx
```
