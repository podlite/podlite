...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
    ...
    peg$c15 = function (name) {
      ...
      if (!top) {
        ...
        options.diagnostics.push({
          ...
          severity: 'error',
          message:
            '=end ' + name + ' does not match =begin ' + top.name + ' (opened at line ' + top.location.start.line + ')',
          location: location(),
        })
    ...
    peg$c19 = function (name) {
      if (options._inDirective) {
        options.diagnostics.push({
          ...
          severity: 'warning',
          message:
            'attribute :' + name + '<…> on continuation line is silently dropped; flatten onto the directive line',
          location: location(),
        })
      }
      return null
    ...
    peg$c30 = peg$otherExpectation('start-of-line'),
    peg$c31 = function () {
