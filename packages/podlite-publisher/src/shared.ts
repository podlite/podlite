...
// Selector mechanics live in @podlite/schema (pure AST queries, no I/O).
// Re-exported here for backward compatibility with downstream code that
// imports `runSelector` from the publisher barrel.
export { runSelector, parseSelector } from '@podlite/schema'
export type { SelectorDoc, ParsedSelector } from '@podlite/schema'
